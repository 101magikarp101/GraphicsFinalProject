import { getDualTypeEffectiveness, type CreatureType } from "./creature-types";
...
const MOVES = [
  { id: "ember_jolt", name: "Ember Jolt", type: "fire", category: "special", basePower: 40, accuracy: 100, pp: 25, priority: 0, effectId: "burn", statusChance: 0.1 },
  { id: "flame_rush", name: "Flame Rush", type: "fire", category: "physical", basePower: 55, accuracy: 95, pp: 20, priority: 0 },
  { id: "smoke_veil", name: "Smoke Veil", type: "fire", category: "status", basePower: 0, accuracy: 100, pp: 20, priority: 0, effectId: "evade_up" },
  { id: "spark_splash", name: "Spark Splash", type: "water", category: "special", basePower: 42, accuracy: 100, pp: 25, priority: 0 },
  { id: "tidal_ram", name: "Tidal Ram", type: "water", category: "physical", basePower: 50, accuracy: 95, pp: 20, priority: 0 },
  { id: "mist_shell", name: "Mist Shell", type: "water", category: "status", basePower: 0, accuracy: 100, pp: 20, priority: 0, effectId: "def_up" },
  { id: "vine_snap", name: "Vine Snap", type: "grass", category: "physical", basePower: 45, accuracy: 100, pp: 25, priority: 0 },
  { id: "spore_burst", name: "Spore Burst", type: "grass", category: "special", basePower: 48, accuracy: 95, pp: 20, priority: 0, effectId: "poison", statusChance: 0.15 },
  { id: "bark_guard", name: "Bark Guard", type: "grass", category: "status", basePower: 0, accuracy: 100, pp: 20, priority: 0, effectId: "def_up" },
  { id: "quick_tap", name: "Quick Tap", type: "normal", category: "physical", basePower: 35, accuracy: 100, pp: 30, priority: 1 },
  { id: "steady_focus", name: "Steady Focus", type: "normal", category: "status", basePower: 0, accuracy: 100, pp: 20, priority: 0, effectId: "atk_up" },
