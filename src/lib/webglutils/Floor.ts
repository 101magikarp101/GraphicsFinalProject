import type { MaterialObject } from "./Objects.js";
...
export class Floor implements MaterialObject {
  ...
  constructor() {
    ...
    this.vertices.forEach((v: Vec4, i: number) => {this.verticesF32.set(v, i*4)});
    ...
    this.ind.forEach((v: Vec3, i: number) => {this.indicesU32.set(v, i*3)});
    ...
    this.norms.forEach((v: Vec4, i: number) => {this.normalsF32.set(v, i*4)});
  }
